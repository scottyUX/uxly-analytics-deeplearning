...
class Transaction(object):
    ...
    def from_moralis_response(response: dict):
        return Transaction(
            ...
            nonce = response[ck.NONCE],
            transaction_index = response[ck.TRANSACTION_INDEX],
            ...
            value = response[ck.VALUE],
            gas = response[ck.GAS],
            gas_price = response[ck.GAS_PRICE],
            input = response[ck.INPUT],
            receipt_cumulative_gas_used = response[ck.REPCEIPT_CUMULATIVE_GAS_USED],
            receipt_gas_used = response[ck.REPCEIPT_GAS_USED],
            ...
            block_number = response[ck.BLOCK_NUMBER],
            block_hash = response[ck.BLOCK_HASH],
            transfer_index = response[ck.TRANSFER_INDEX],
            transaction_fee = response[ck.TRANSACTION_FEE],
        )
